...
function LoginForm() {
  ...
  return (
    <div className="card w-full max-w-md p-8 shadow-2xl">
      <div className="mb-6">
        <div className="text-sm muted mb-2">Coding Agent Platform</div>
      ...
      {oidcEnabled ? (
        <a className="btn btn-primary mt-3 block w-full text-center" href={`${api.base}/api/v1/auth/oidc/login`}>
          使用 OIDC 登录
        </a>
      ) : null}
